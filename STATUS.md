...
BioSieve is a toolkit for **redundancy reduction** and **dataset splitting** designed for biological sequence datasets (and optionally embeddings/descriptors/structures). The goal is to provide **leakage-aware, reproducible** workflows via a stable CLI + config system.
